			...
			<div className='min-h-[100vh] sm:min-h-screen w-screen flex flex-col relative bg-[#F2F3F5] font-inter overflow-hidden'>
				...
				<main className='flex flex-col justify-center h-[90%] static md:fixed w-screen overflow-hidden grid-rows-[1fr_repeat(3,auto)_1fr] z-[100] pt-[30px] pb-[320px] px-4 md:px-20 md:py-0'>
					...
					<motion.h1
						...
						className='relative md:ml-[-10px] md:mb-[37px] font-extrabold text-[16vw] md:text-[130px] font-inter text-[#1E2B3A] leading-[1] tracking-[-2px] z-[100]'>
						Technology <br />
						make world <span className='text-[#407BBF]'>better</span>
					...
					<motion.div
						...
						<div className='w-1/2'>
							...
							<p className='text-[14px] leading-[20px] text-[#1a2b3b] font-normal'>
								An information management tool for the AI era. Consolidate
								information and provides a report.
							</p>
						</div>
						<div className='w-1/2'>
							<h2 className='flex items-center font-semibold text-[1em] text-[#1a2b3b]'>
					...
					<div className='flex gap-[15px] mt-8 md:mt-0'>
						<motion.div
							...
							<Link
								...
								target='_blank'
								className='group rounded-full pl-[8px] min-w-[180px] pr-4 py-2 text-[13px] font-semibold transition-all flex items-center justify-center bg-[#1E2B3A] text-white hover:[linear-gradient(0deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0.1)), #0D2247] no-underline gap-x-2  active:scale-95 scale-100 duration-75'
								style={{
									boxShadow:
						...
						<motion.div
							...
							<Link
								href='https://github.com/Qingyon-AI/Revornix/discussions/1#discussioncomment-13638435'
								target='_blank'
